...
CREATE USER 'll_local'@'127.0.0.1' IDENTIFIED WITH caching_sha2_password BY 'rootpw';
CREATE USER 'll_local'@'172.18.%.%' IDENTIFIED WITH caching_sha2_password BY 'rootpw';

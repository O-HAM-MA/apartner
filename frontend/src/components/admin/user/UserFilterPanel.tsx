...
import { SearchOutlined, FilterOutlined, DownloadOutlined, ClearOutlined, ReloadOutlined } from '@ant-design/icons';
...
interface UserFilterPanelProps {
  onSearch: (searchTerm: string, role: string | undefined, status: UserStatus | undefined) => void;
  onExport: (format: 'csv' | 'excel') => void;
  onFilterApply: (values: FilterValues) => void;
  onReset?: () => void; // 초기화 핸들러 추가
}

const UserFilterPanel: React.FC<UserFilterPanelProps> = ({ onSearch, onExport, onFilterApply, onReset }) => {
      ...
      <Space direction="vertical" style={{ width: '100%' }} size="middle">
        ...
        <div className="flex justify-end">
          <Space>
            ...
            <Button onClick={() => onExport('excel')} icon={<DownloadOutlined />}>
              Excel 내보내기
            </Button>
          </Space>
        </div>
